...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "http://localhost:8080", "http://127.0.0.1:8080","https://plot-twist-lac.vercel.app","https://plot-twist-nikk434s-projects.vercel.app"],  # Add your frontend URLs
